...
export WINNAKER_XPATH_PIPELINE_EXECUTION_SUMMARY="//execution[1]//div[@class='execution-summary']"
export WINNAKER_XPATH_PIPLELINE_TRIGGER_DETAILS="//execution[1]//ul[@class='trigger-details']"
export WINNAKER_XPATH_PIPLELINE_DETAILS_LINK="//execution[1]//execution-status//div/a[contains(., 'Details')]"
